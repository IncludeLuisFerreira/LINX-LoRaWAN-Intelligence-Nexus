...
#elif defined(AU915_928LA)
// Australian plan or Everynet_ATC/Lora frequencies
vector freqs [] = { 
  { 915200000, 125, 7, 10, 915200000, 125, 7, 12 },      // Channel 0, 915.2 MHz primary
  { 915400000, 125, 7, 10, 915400000, 125, 7, 12 },      // Channel 1, 915.4 MHz mandatory
  { 915600000, 125, 7, 10, 915600000, 125, 7, 12 },      // Channel 2, 915.6 MHz mandatory
  { 915800000, 125, 7, 10, 915800000, 125, 7, 12 },      // Channel 3, 915.8 MHz Optional
  { 916000000, 125, 7, 10, 916000000, 125, 7, 12 },      // Channel 4, 916.0 MHz Optional
  { 916200000, 125, 7, 10, 916200000, 125, 7, 12 },      // Channel 5, 916.2 MHz Optional
  { 916400000, 125, 7, 10, 916400000, 125, 7, 12 },      // Channel 6, 916.4 MHz Optional 
  { 916600000, 125, 7, 10, 916600000, 125, 7, 12 }       // Channel 7, 916.6 MHz Optional
//  { 917500000, 500, 8,  8,         0,   0, 0,  0 }       // Channel 8, 917.5 SF8BW500 MHz Optional Uplink
};
...
#elif _PIN_OUT==4
// ----------------------------------------------------------------------------
// For ESP32/TTGO based board.  //placa RF95
// SCK  == GPIO5/  PIN5
// SS   == GPIO18/ PIN18 CS
// MISO == GPIO19/ PIN19
// MOSI == GPIO27/ PIN27
...
struct pins {
	...
	uint8_t ss=18;			// GPIO18/ CS. Select pin connected to GPIO18 // AAF Board 5 // PK 18
	uint8_t rst=14;			// GPIO14/ D3. Reset pin not used	
} pins;
#define SCK 5 // AAF Board 18 // PK 5
#define MISO 19
#define MOSI 27 // AAF Board 23 // PK 27
#define RST 14
#define SS 18 // AAF Board 5 // PK 18
