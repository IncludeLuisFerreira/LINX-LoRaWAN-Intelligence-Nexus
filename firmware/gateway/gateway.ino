...
#	define ESP32_ARCH 1
#	ifndef _PIN_OUT
#		define _PIN_OUT 4									// For ESP32 pin-out 4 is default  //colocar a placa aqui
#	endif
...
// --- Correção para funções Base64 ausentes no Core novo do ESP32 ---
#ifdef __cplusplus
extern "C" {
#endif
...
#	if _MONITOR>=1
	if (debug>=0) {
		...
		printHexDigit(0xFF,			response); //0xFF
