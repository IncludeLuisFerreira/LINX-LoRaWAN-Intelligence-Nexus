...
#define NTP_TIMEZONES	-3					// How far is our Timezone from UTC (excl daylight saving/summer time): -3 Brazil
...
#define _STAT_INTERVAL 30  //120					// Send a 'stat' message to server
